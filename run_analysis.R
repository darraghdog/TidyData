...
download.file(fileURL, destfile = "./JohnHopkins/tidydata/tidydataproject.zip")

# This funtion lists the file names to ensure they are downloaded correctly

list.files("./JohnHopkins/tidydata/")
...
unzip("./JohnHopkins/tidydata/tidydataproject.zip", list = FALSE, overwrite = TRUE, exdir = "./JohnHopkins/tidydata")

# Read the X_text files

list.files("./JohnHopkins/tidydata/UCI HAR Dataset/")

features <- read.table("~/JohnHopkins/tidydata/UCI HAR Dataset/features.txt", quote="\"")
X_test <- read.table("~/JohnHopkins/tidydata/UCI HAR Dataset/test/X_test.txt", quote="\"")
X_train <- read.table("~/JohnHopkins/tidydata/UCI HAR Dataset/train/X_train.txt", quote="\"")
subject_test <- read.table("~/JohnHopkins/tidydata/UCI HAR Dataset/test/subject_test.txt", quote="\"")
subject_train <- read.table("~/JohnHopkins/tidydata/UCI HAR Dataset/train/subject_train.txt", quote="\"")
Y_test <- read.table("~/JohnHopkins/tidydata/UCI HAR Dataset/test/Y_test.txt", quote="\"")
Y_train <- read.table("~/JohnHopkins/tidydata/UCI HAR Dataset/train/Y_train.txt", quote="\"")
activity_labels <- read.table("~/JohnHopkins/tidydata/UCI HAR Dataset/activity_labels.txt", quote="\"")
...
full_set1$act_subject <- as.factor(full_set1$act_subject)
